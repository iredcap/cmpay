...
class UserApp extends BaseAdmin
{
    /**
     * 账户API
     *
    ...
    public function getList(){
        ...
        $data = $this->logicUserApp->getApiList($where, '*', 'create_time desc', false);

        $count = $this->logicUserApp->getApiCount($where);
    ...
    public function edit(){
        // post 是提交数据
        $this->request->isPost() && $this->result($this->logicUserApp->editApi($this->request->post()));
        //获取商户API信息

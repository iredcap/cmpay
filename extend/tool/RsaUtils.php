...
class RsaUtils
{
    ...
    public function exportOpenSSLFile($filename = ''){
        ...
        if (!is_dir(DATA_PATH . "openssl/export/"))  mkdir(DATA_PATH . "openssl/export/", 0777);
        file_put_contents(DATA_PATH . "openssl/export/". $filename ."_public.pem", $public_key);
        file_put_contents(DATA_PATH . "openssl/export/". $filename ."_private.pem", $private_key);
    }
}